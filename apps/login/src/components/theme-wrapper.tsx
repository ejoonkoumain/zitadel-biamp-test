...
export const ThemeWrapper = ({ children, branding }: Props) => {
  ...
  useLayoutEffect(() => {
    ...
    if (branding?.fontUrl) {
      ...
      // Capture the current font-family (Open Sans from next/font) before overriding,
      ...
      // Inline style overrides the class-based Open Sans from next/font
      document.documentElement.style.setProperty("font-family", fontStack);
    } else {
      // No custom font — remove injected style and let the Open Sans class take over
