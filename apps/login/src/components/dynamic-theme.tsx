                      ...
                      <div className="mx-auto max-w-[440px] space-y-8">
                        ...
                        {hasLeftRightStructure && (
                          <div className="flex flex-col items-start space-y-4 text-left">
                            ...
                            <div className="[&_h1]:text-h1 [&_h1]:lg:text-h1 space-y-6 [&_h1]:text-left [&_h1]:text-gray-900 [&_h1]:dark:text-white [&_p]:text-left [&_p]:leading-relaxed [&_p]:text-gray-700 [&_p]:dark:text-gray-300">
                              {leftContent}
                            </div>
                          </div>
                        )}
