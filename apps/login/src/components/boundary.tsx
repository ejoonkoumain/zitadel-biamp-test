  ...
  return (
    <div
      className={clsx("rounded-full px-1.5", {
        ...
        "bg-state-error-light-color text-state-error-light-background": color === "red",
  ...
  return (
    <div
      className={clsx("relative rounded-lg border border-dashed", {
        ...
        "border-state-error-light-color": color === "red",
    ...
    >
      <div
        className={clsx("text-sidebar absolute -top-2 flex space-x-1 leading-4 tracking-widest uppercase", {
