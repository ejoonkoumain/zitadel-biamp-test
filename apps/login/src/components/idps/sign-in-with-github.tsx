...
function GitHubLogo() {
  return (
    <>
      {/* Near-white mark: hidden in light mode, shown in dark mode. */}
      <Box
        component="svg"
      ...
      {/* Near-black mark: shown in light mode, hidden in dark mode. */}
      <Box
        component="svg"
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  function SignInWithGithub(props, ref) {
    ...
    return (
      <BaseButton {...restProps} ref={ref}>
        <Box sx={{ mx: 1, my: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <GitHubLogo />
        </Box>
        {children ? (
          children
