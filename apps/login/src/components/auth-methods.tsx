...
// Tile styling for the auth-method cards below. Colour comes entirely from
// the theme (Paper's default background/text, `divider` for the border) —
// no light/dark variants are needed since MUI resolves those tokens itself.
const tileSx = (alreadyAdded: boolean) => ({
  ...
  textDecoration: "none",
  color: "inherit",
  "&:hover": alreadyAdded ? undefined : { boxShadow: 4 },
});

const LinkWrapper = ({ alreadyAdded, children, link }: { alreadyAdded: boolean; children: ReactNode; link: string }) => {
  return !alreadyAdded ? (
    <Paper component={Link} href={link} elevation={0} sx={tileSx(alreadyAdded)}>
      {children}
    </Paper>
  ) : (
    <Paper elevation={0} sx={tileSx(alreadyAdded)}>
      {children}
    </Paper>
  );
};
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography fontWeight={500}>Authenticator App</Typography>
      </Stack>
      {alreadyAdded && <Setup />}
    </LinkWrapper>
  );
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography fontWeight={500}>Universal Second Factor</Typography>
      </Stack>
      {alreadyAdded && <Setup />}
    </LinkWrapper>
  );
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography fontWeight={500}>Code via Email</Typography>
      </Stack>
      {alreadyAdded && <Setup />}
    </LinkWrapper>
  );
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography fontWeight={500}>Code via SMS</Typography>
      </Stack>
      {alreadyAdded && <Setup />}
    </LinkWrapper>
  );
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography fontWeight={500}>Passkeys</Typography>
      </Stack>
      {alreadyAdded && <Setup />}
    </LinkWrapper>
  );
    ...
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      <Stack direction="row" alignItems="center">
        <Box
          ...
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          sx={{ width: 32, height: 28, mr: 2, flexShrink: 0 }}
        >
